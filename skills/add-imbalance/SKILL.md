...
name: add-imbalance
description: >
  Detect ADD flow imbalances and provide appropriate support. Use when the user
  seems stuck — analysis paralysis, decision avoidance, execution shortcuts,
  perpetual doing, or mid-execution second-guessing. Imbalances cascade; address at source.
---
